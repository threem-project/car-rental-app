...
@Transactional
@ActiveProfiles("test")
public class CarServiceByMarikaTest {
    ...
    @InjectMocks
    private CarServiceByMarika carServiceByMarika;
...
//
//        carServiceByMarika.createCar(carDto);
//
...
//        CarServiceByMarika carServiceByMarikaSpy = Mockito.spy(new CarServiceByMarika(carRepositoryMock, branchRepositoryMock, carMapperMock, equipmentRepositoryMock));
//        carServiceByMarikaSpy.createCar(carDto);
//
//        // then: reaches carRepository(carEntity)
//
//        Mockito.verify(carServiceByMarikaSpy, times(1)).createCar(carDto); // method was reached = all carService code was executed
//
//    }
//
